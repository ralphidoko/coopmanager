    ...
    <div class="pull-right" style="width: 100%; display: flex; justify-content: center; align-items: center;">
        <table id="saving">
            ...
            <tr id="s">
                ...
                <th id="s">TOTAL WITHDRAWAL(<del style="text-decoration-style: double">N</del>)</th>
            </tr>
            </thead>
            <tbody>
            <?php $counter = 1; ?>
            <?php $__currentLoopData = $monthlyDrawings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $monthlyDrawing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr id="s">
                    <td id="s"><?php echo e($counter++); ?></td>
                    <td id="s"><?php echo e($monthlyDrawing->description); ?></td>
                    <td id="s"><?php echo e(date('M-Y',strtotime($monthlyDrawing->month_year))); ?></td>
                    <td id="s" style="text-align: right"><?php echo e(number_format($monthlyDrawing->amount_withdrawn,2)); ?></td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <tr id="figure" style="border: 1px solid #0a0a0a ! important;">
                <td colspan="2"><b>Total Withdrawals</b></td>
                <td colspan="2" style="text-align: right ! important;"><b><?php echo e(number_format($totalDrawings,2)); ?></b></td>
            </tr>
            </tbody>
        </table>
    </div>
...
<?php /**PATH C:\xampp\htdocs\coopmanager\resources\views/dashboard/admin/reports/monthlyWithdrawalStatement.blade.php ENDPATH**/ ?>