...
} elseif ($_instance->childHasBeenRendered('grkKr9u')) {
    $componentId = $_instance->getRenderedChildComponentId('grkKr9u');
    $componentTag = $_instance->getRenderedChildComponentTagName('grkKr9u');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('grkKr9u');
} else {
    $response = \Livewire\Livewire::mount('change-password', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('grkKr9u', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </div>
