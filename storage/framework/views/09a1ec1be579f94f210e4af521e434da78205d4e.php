                    ...
                    <div class="col-xs-12">
                        <div class="box box-danger" >
                                <div class="box-header" style="margin-top: 10px">
                                    <?php if(Auth::user()->user_role == 'Admin1' && $loan[0]->status == 'Processing'): ?>
                                    ...
                                    <?php elseif(Auth::user()->user_role == 'Admin1' && $loan[0]->status == 'Rejected'): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if(Auth::user()->user_role == 'Admin2' && $loan[0]->status == 'Processing'): ?>
                                            <button style="font-weight: bold;font-size: 15px;" type="submit" id="sec_approve" value="sec_approved" class="btn btn-primary">Sec Approve Loan</button>
                                            <button style="font-weight: bold;font-size: 15px;" type="submit" id="reject_loan" value="reject_loan" class="btn btn-danger">Reject Application</button>
                                    <?php elseif(Auth::user()->user_role == 'Admin2' && $loan[0]->status == "Rejected"): ?>
                                            <button style="font-weight: bold;font-size: 15px;" type="submit" id="revoke_rejection" value="revoke_rejection" class="btn btn-bitbucket">Set to Draft</button>
                                    <?php endif; ?>
                                    ...
                                    <script>
                                        ...
                                        $( "#sec_approve" ).on( "click", function(e) {
                                            ...
                                            $('.preloader').show();
                                                ...
                                                data = {_token: "<?php echo e(csrf_token()); ?>", sec_approve: sec_approve, loan_id: loan_id,};

                                                $.ajax({
                                                    url: '<?php echo e(URL::to('/handleLoanAdminApproval')); ?>',
                                                    type: 'POST',
                                                    dataType: 'json',
                                                    data: data,
                                        ...
                                        $( "#chair_approve" ).on( "click", function(e) {
                                            ...
                                            data = {_token: "<?php echo e(csrf_token()); ?>", chair_approve: chair_approve, loan_id: loan_id,};
                                        ...
                                        $( "#reject_loan" ).on( "click", function(e) {
                                            ...
                                            data = {_token: "<?php echo e(csrf_token()); ?>", reject_loan: reject_loan, loan_id: loan_id, reason_for_rejection: reason_for_rejection};
                                        ...
                                        $( "#revoke_rejection" ).on( "click", function(e) {
                                            ...
                                            data = {_token: "<?php echo e(csrf_token()); ?>", revoke_rejection: revoke_rejection, loan_id: loan_id,};
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="box-body table-responsive">
                                                      <table class="table table-bordered table-striped" style="border: 2px;">
                                                        <input type="hidden" value="<?php echo e($loan[0]->id); ?>" id="loan_id" />
                                                        <input type="hidden" value="<?php echo e($loan[0]->sec_approve); ?>" id="loan_sec_app" />
                                                        <input type="hidden" value="<?php echo e($loan[0]->chair_approve); ?>" id="loan_chair_app" />
                                                        <thead>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="border: 1px solid black; width: 150px">
                                                                    <img src="<?php echo e(asset('/storage/'. $loan[0]->passport_url)); ?>" class="user-image" height="150" width="150">
                                                                </td>
                                                                <td style="font-size: large;"><strong>Applicant:</strong>&#160;&#160;<?php echo e($loan[0]->name); ?><br/>
                                                                    <strong>Membership No:</strong>&#160;&#160;&#160;<?php echo e($loan[0]->member_id); ?><br/>
                                                                    <strong>Account No:</strong>&#160;&#160;&#160;<?php echo e($loan[0]->ippis_no); ?><br/>
                                                                    <strong>Designation:</strong>&#160;&#160;&#160;<?php echo e($loan[0]->designation); ?><br/>
                                                                    <strong>Department:</strong>&#160;&#160;<?php echo e($loan[0]->department); ?><br/>
                                                                    <strong>Telephone:</strong>&#160;&#160;&#160;<?php echo e($loan[0]->phone_no); ?><br/>
                                                                </td>
                                                                <td style="font-size: large;"><strong>Submission Date</strong>&#160;&#160;<?php echo e(date("d-M-Y",strtotime($loan[0]->created_at))); ?><br/>
                                                                    <strong>Loan Type:</strong>&#160;&#160;&#160;<?php echo e($loan[0]->loan_type); ?><br/>
                                                                    <strong>Principal Amount:</strong>&#160;&#160;&#160;<del style="text-decoration-style: double">N</del><?php echo e(number_format($loan[0]->loan_amount,2)); ?><br/>
                                                                    <strong>Loan Tenor:</strong>&#160;&#160;&#160;<?php echo e($loan[0]->cash_loan_tenor.' Months'); ?><br/>
                                                                    <strong>Interest Rate:</strong>&#160;&#160;&#160;<?php echo e($loan[0]->cash_loan_rate.'%'); ?><br/>
                                                                </td>
                                                                <td style="font-size: large;"><strong>Total Amount Payable</strong>&#160;&#160;<del style="text-decoration-style: double">N</del><?php echo e(number_format($loan[0]->total_amount_payable,2)); ?><br/>
                                                                    <strong>Total Interest Payable:</strong>&#160;&#160;&#160;<del style="text-decoration-style: double">N</del><?php echo e(number_format($loan[0]->total_interest_payable,2)); ?><br/>
                                                                    <strong>Monthly Installment:</strong>&#160;&#160;&#160;<del style="text-decoration-style: double">N</del><?php echo e(number_format($loan[0]->monthly_interest_payable,2)); ?><br/>
                                                                    ...
                                                                    <strong>Loan Balance:</strong>&#160;&#160;&#160;<del style="text-decoration-style: double">N</del><?php echo e(number_format($loan[0]->total_amount_payable - $total_installment_paid,2)); ?><br/>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane" id="tab_2-2">
                                                    <table id="example2" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                        <tr>
                                                            <td><?php echo e($loan[0]->guarantor_one); ?></td>
                                                            <td><?php echo e($loan[0]->g1_phone_no); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><?php echo e($loan[0]->guarantor_two); ?></td>
                                                            <td><?php echo e($loan[0]->g2_phone_no); ?></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                                ...
                                                <div class="tab-pane" id="tab_3-2">
                                                    <?php echo e($loan[0]->reason_for_rejection); ?>
...
} elseif ($_instance->childHasBeenRendered('RWEhShV')) {
    $componentId = $_instance->getRenderedChildComponentId('RWEhShV');
    $componentTag = $_instance->getRenderedChildComponentTagName('RWEhShV');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RWEhShV');
} else {
    $response = \Livewire\Livewire::mount('change-password', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('RWEhShV', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </div>
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\coopmanager\resources\views/dashboard/admin/adminLoanApproval.blade.php ENDPATH**/ ?>