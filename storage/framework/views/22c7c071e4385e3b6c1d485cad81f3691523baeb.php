...
} elseif ($_instance->childHasBeenRendered('ZScWFK7')) {
    $componentId = $_instance->getRenderedChildComponentId('ZScWFK7');
    $componentTag = $_instance->getRenderedChildComponentTagName('ZScWFK7');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ZScWFK7');
} else {
    $response = \Livewire\Livewire::mount('change-password', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('ZScWFK7', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </div>
