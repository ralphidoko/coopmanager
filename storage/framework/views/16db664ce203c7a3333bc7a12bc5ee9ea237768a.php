...
} elseif ($_instance->childHasBeenRendered('QMCWdFG')) {
    $componentId = $_instance->getRenderedChildComponentId('QMCWdFG');
    $componentTag = $_instance->getRenderedChildComponentTagName('QMCWdFG');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QMCWdFG');
} else {
    $response = \Livewire\Livewire::mount('change-password', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('QMCWdFG', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </div>
