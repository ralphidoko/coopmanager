...
} elseif ($_instance->childHasBeenRendered('vkkprmL')) {
    $componentId = $_instance->getRenderedChildComponentId('vkkprmL');
    $componentTag = $_instance->getRenderedChildComponentTagName('vkkprmL');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('vkkprmL');
} else {
    $response = \Livewire\Livewire::mount('upload-profile-image', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('vkkprmL', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
                    <hr>
