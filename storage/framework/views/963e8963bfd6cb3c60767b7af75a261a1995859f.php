...
} elseif ($_instance->childHasBeenRendered('C4J5yFU')) {
    $componentId = $_instance->getRenderedChildComponentId('C4J5yFU');
    $componentTag = $_instance->getRenderedChildComponentTagName('C4J5yFU');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('C4J5yFU');
} else {
    $response = \Livewire\Livewire::mount('change-password', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('C4J5yFU', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
<?php
...
} elseif ($_instance->childHasBeenRendered('Wtndc23')) {
    $componentId = $_instance->getRenderedChildComponentId('Wtndc23');
    $componentTag = $_instance->getRenderedChildComponentTagName('Wtndc23');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Wtndc23');
} else {
    $response = \Livewire\Livewire::mount('allow-admin', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('Wtndc23', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
