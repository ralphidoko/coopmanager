...
} elseif ($_instance->childHasBeenRendered('PN0w182')) {
    $componentId = $_instance->getRenderedChildComponentId('PN0w182');
    $componentTag = $_instance->getRenderedChildComponentTagName('PN0w182');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PN0w182');
} else {
    $response = \Livewire\Livewire::mount('change-password', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('PN0w182', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
