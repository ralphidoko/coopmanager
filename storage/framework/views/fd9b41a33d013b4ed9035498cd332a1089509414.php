    ...
    <form method="POST" action="<?php echo e(route('pay')); ?>" accept-charset="UTF-8" class="form-horizontal" role="form">
        <div class="row" style="margin-bottom:40px; display: block !important;">
            <div class="col-md-8 col-md-offset-2">
                ...
                <input type="hidden" name="metadata" value="<?php echo e(json_encode($array = ['type' => 'account_closure',])); ?>" > 
...
<?php /**PATH C:\xampp\htdocs\coopmanager\resources\views/dashboard/accountActivation/accountClosurePayment.blade.php ENDPATH**/ ?>