...
} elseif ($_instance->childHasBeenRendered('wn8DVeD')) {
    $componentId = $_instance->getRenderedChildComponentId('wn8DVeD');
    $componentTag = $_instance->getRenderedChildComponentTagName('wn8DVeD');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wn8DVeD');
} else {
    $response = \Livewire\Livewire::mount('change-password', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('wn8DVeD', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </div>
