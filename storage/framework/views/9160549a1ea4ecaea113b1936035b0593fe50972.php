...
} elseif ($_instance->childHasBeenRendered('PtIN8r9')) {
    $componentId = $_instance->getRenderedChildComponentId('PtIN8r9');
    $componentTag = $_instance->getRenderedChildComponentTagName('PtIN8r9');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PtIN8r9');
} else {
    $response = \Livewire\Livewire::mount('allow-admin', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('PtIN8r9', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
} elseif ($_instance->childHasBeenRendered('ixK9IOG')) {
    $componentId = $_instance->getRenderedChildComponentId('ixK9IOG');
    $componentTag = $_instance->getRenderedChildComponentTagName('ixK9IOG');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ixK9IOG');
} else {
    $response = \Livewire\Livewire::mount('change-password', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('ixK9IOG', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </div>
