<div class="row col-md-10 col-lg-10 flex justify-content-center col-xs-12 hidden hidden-xs visible-lg">
    <div class="pull-right" style="width: 100%; display: flex; justify-content: center; align-items: center;">
        ...
        <span style="font-size: 23px; font-weight: bolder; color: #0c5460; line-height: 17px;">
...
<?php /**PATH C:\xampp\htdocs\coopmanager\resources\views/dashboard/coopLogo.blade.php ENDPATH**/ ?>