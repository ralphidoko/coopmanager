                    ...
                    <div class="col-xs-12">
                        <div class="box box-danger">
                            <div class="box-header">
                               ...
                               <?php if(Auth::user()->user_role == 'Admin1' && $application->membership_status == 'Active'): ?>
                                  
                               <?php elseif(Auth::user()->user_role == 'Admin1' && $application->membership_status== "Archived"): ?>
                                    <button style="font-weight: bold;font-size: 15px;" type="submit"  class="btn btn-danger">Archived</button>
                               <?php elseif(Auth::user()->user_role == 'Admin2' && $application->membership_status == 'Active'): ?>
                                    
                               <?php elseif(Auth::user()->user_role == 'Admin2' && $application->membership_status== "Archived"): ?>
                                    <button style="font-weight: bold;font-size: 15px;" type="submit"  class="btn btn-danger">Archived</button>
                               <?php endif; ?>
                                            ...
                                            <div class="box-body" style="padding-bottom: 400px">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="box-body table-responsive">
                                                        ...
                                                        <input type="hidden" value="<?php echo e($application->users->id); ?>" id="user_id" />
                                                        ...
                                                        <tbody>
                                                        <tr>
                                                            <?php if($application->users->passport_url): ?>
                                                            ...
                                                            <td>
                                                                ...
                                                                <strong>Staff No:</strong>&#160;&#160;&#160;<?php echo e($application->users->ippis_no); ?><br/>
                                                        ...
                                                        <script>
                                                            $('#customSwitch1').change(function () {
                                                                if(!confirm('You are granting permission for multiple loans, are you sure')) {
                                                                    ...
                                                                    data = {granted: this.checked,user_id:user_id,_token: "<?php echo e(csrf_token()); ?>"}
                                                                        $.ajax({
                                                                            dataType: 'json',
                                                                            type: "POST",
                                                                            url: '<?php echo e(URL::to('/permitMultipleLoan')); ?>',
                                                                            data: data,
                                                                            success: function (response) {
                                                                                if(response.success === true) {
                                                                                    toastr.success(response.message);
...
} elseif ($_instance->childHasBeenRendered('8lVXYBR')) {
    $componentId = $_instance->getRenderedChildComponentId('8lVXYBR');
    $componentTag = $_instance->getRenderedChildComponentTagName('8lVXYBR');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8lVXYBR');
} else {
    $response = \Livewire\Livewire::mount('change-password', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('8lVXYBR', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </div>
