...
} elseif ($_instance->childHasBeenRendered('LA3AOWh')) {
    $componentId = $_instance->getRenderedChildComponentId('LA3AOWh');
    $componentTag = $_instance->getRenderedChildComponentTagName('LA3AOWh');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LA3AOWh');
} else {
    $response = \Livewire\Livewire::mount('change-password', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('LA3AOWh', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </div>
