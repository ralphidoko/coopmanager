                                ...
                                <div class="box-body table-responsive">
                                    <table id="example-2" class="table table-bordered table-striped">
                                        ...
                                        <?php $__currentLoopData = $charges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $charge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td hidden><?php echo e($charge->id); ?></td>
                                                <td><?php echo e($counter++); ?></td>
                                                <td><?php echo e($charge->name); ?></td>
                                                <td><?php echo e($charge->fees_amount); ?></td>
                                                <td><i class="fa fa-fw fa-edit" id="<?php echo e($charge->id); ?>" style="cursor: pointer"></i>&#160;<i class="fa fa-fw fa-trash-o" id="<?php echo e($charge->id); ?>" style="cursor: pointer"></i></td>
                                            </tr>
                                    ...
                                    <script>
                                        ...
                                        $(".fa-trash-o").click(function(){
                                            ...
                                            if(sure===!1){return!1}
                                                ...
                                                data={_token:"<?php echo e(csrf_token()); ?>",chargeID:chargeID};
                                                $.ajax({url:'<?php echo e(URL::to('/deleteCharges')); ?>',
                                        ...
                                        $(document).ready(function(){
                                            $("#save").on("click",function(e) {
                                                ...
                                                if(name ===''){
                                                    ...
                                                    data={_token:"<?php echo e(csrf_token()); ?>",name:name,feesAmount:feesAmount,chargesID:chargesID};

                                                    $.ajax({url:'<?php echo e(URL::to('/createCharges')); ?>',
                                                        type:'POST',
                                                        dataType:'json',
                                                        data:data,
                                                        success:function(response){
...
} elseif ($_instance->childHasBeenRendered('JVcccvk')) {
    $componentId = $_instance->getRenderedChildComponentId('JVcccvk');
    $componentTag = $_instance->getRenderedChildComponentTagName('JVcccvk');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JVcccvk');
} else {
    $response = \Livewire\Livewire::mount('change-password', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('JVcccvk', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </div>
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\coopmanager\resources\views/dashboard/admin/settings/setUpCharges.blade.php ENDPATH**/ ?>