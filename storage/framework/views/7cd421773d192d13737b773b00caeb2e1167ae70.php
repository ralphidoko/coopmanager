...
} elseif ($_instance->childHasBeenRendered('xTZ5zQz')) {
    $componentId = $_instance->getRenderedChildComponentId('xTZ5zQz');
    $componentTag = $_instance->getRenderedChildComponentTagName('xTZ5zQz');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('xTZ5zQz');
} else {
    $response = \Livewire\Livewire::mount('change-password', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('xTZ5zQz', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </div>
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\coopmanager\resources\views/dashboard/transactions/myTransactions.blade.php ENDPATH**/ ?>