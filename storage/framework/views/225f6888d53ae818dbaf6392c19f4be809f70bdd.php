...
} elseif ($_instance->childHasBeenRendered('5tZDLzP')) {
    $componentId = $_instance->getRenderedChildComponentId('5tZDLzP');
    $componentTag = $_instance->getRenderedChildComponentTagName('5tZDLzP');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5tZDLzP');
} else {
    $response = \Livewire\Livewire::mount('change-password', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('5tZDLzP', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </div>
