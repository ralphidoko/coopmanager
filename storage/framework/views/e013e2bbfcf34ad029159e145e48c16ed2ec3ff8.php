                                ...
                                <div class="box-body DisplayAccountDiv">
                                    ...
                                    <table id="example-2" class="table table-bordered table-striped">
                                        ...
                                        <?php $__currentLoopData = $journals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $journal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td hidden><?php echo e($journal->id); ?></td>
                                                <td><?php echo e($counter++); ?></td>
                                                <td><?php echo e($journal->code); ?></td>
                                                <td><?php echo e($journal->name); ?></td>
                                                <td><?php echo e($journal->types->name); ?></td>
                                                <td><i class="fa fa-fw fa-edit" id="<?php echo e($journal->id); ?>" style="cursor: pointer"></i>&#160;<i class="fa fa-fw fa-trash-o" id="<?php echo e($journal->id); ?>" style="cursor: pointer"></i></td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tbody>
                                    </table>
                                <script>
                                    ...
                                    $(".fa-trash-o").click(function(){
                                        ...
                                        if(sure===!1){return!1}
                                            ...
                                            $.ajax({url:'<?php echo e(URL::to('/deleteAccountJournal')); ?>',
                                    ...
                                    $(document).ready(function(){
                                        $("#save").on("click",function(e) {
                                            ...
                                            if(code===''){
                                                ...
                                                data={_token:"<?php echo e(csrf_token()); ?>",code:code, name:name, type:type,allow_cancel:allow_cancel};

                                                $.ajax({url:'<?php echo e(URL::to('/createAccountJournal')); ?>',
                                                    type:'POST',
                                                    dataType:'json',
                                                    data:data,
                                                    success:function(response){
                                    ...
                                    $(document).ready(function(){
                                        $("#updateAccount").on("click",function(e) {
                                            ...
                                            if(code===''){
                                                ...
                                                data={_token:"<?php echo e(csrf_token()); ?>",chartID:chartID,code:code, name:name, type:type,allow_cancel:allow_cancel};
                                                $.ajax({url:'<?php echo e(URL::to('/updateAccountJournal')); ?>',
                                                    type:'PUT',
                                                    dataType:'json',
                                                    data:data,
                                                    success:function(response){
...
} elseif ($_instance->childHasBeenRendered('zjhMAWF')) {
    $componentId = $_instance->getRenderedChildComponentId('zjhMAWF');
    $componentTag = $_instance->getRenderedChildComponentTagName('zjhMAWF');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zjhMAWF');
} else {
    $response = \Livewire\Livewire::mount('change-password', []);
    $dom = $response->dom;
    $_instance->logRenderedChild('zjhMAWF', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
    </div>
...
<?php echo $__env->make('dashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\coopmanager\resources\views/dashboard/admin/accounting/createJournals.blade.php ENDPATH**/ ?>