            ...
            <div class="box box-danger " style="margin-top: 70px;">
                    ...
                    <div role="form">
                        ...
                        <form id="enrollmentForm">
                            <input type="text" hidden id="ippis_no" value="{{\Illuminate\Support\Facades\Auth::user()->ippis_no}}" />
                            @csrf
                                ...
                                <div style="display: inline-flex">
                                    <div class="form-group col-md-10 col-lg-10">
                                        ...
                                        @if($current_saving != null)
                                            <input type="text" style="font-size: 25px; font-weight: bolder;" class="form-control" id="current_amount" value="{{number_format($current_saving->authorized_amount,2)}}">
                                        @else
                            ...
                            <div class="" align="center">
                                <button type="submit" id="submit_auth" data-token="{{ csrf_token() }}" class="btn btn-primary">Submit Authorization</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <script>
                ...
                $( "#submit_auth" ).on( "click", function(e) {
                    ...
                    if($("#auth_type").val() == 1 && $("#desired_amount").val() === "") {
                        ...
                        $.ajax({
                            url: '{{URL::to('/handleSavingAuthorization')}}',
                            type: 'POST',
                            dataType: 'json',
                            data: data,
