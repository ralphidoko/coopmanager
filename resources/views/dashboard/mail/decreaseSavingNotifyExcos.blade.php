<p class="container" style="justify-content: center;padding: 10px;">
    ...
    <p>An authorization to decrease saving has just been submitted by {{strtoupper($deduction_details['user_name'])}}:</p>
...
<p>You can <a href="http://localhost:8000/login" target="_blank">login here</a></p>
