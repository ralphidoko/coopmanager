                    ...
                    <form  method="" action="">
                        ...
                        <div style="display: inline-flex;" class="col-md-10 col-lg-12">
                            ...
                            <div class="form-group col-md-10 col-lg-10">
                                ...
                                <input type="text" class="form-control" name="last_name" id="last_name" value="{{$member->last_name}}">
                        ...
                        <div style="display: inline-flex;" class="col-md-10 col-lg-12">
                            <div class="form-group col-md-10 col-lg-12">
                                ...
                                <input type="text" class="form-control" name="office_location" id="office_location" value="{{$member->office_location}}">
                                <p id="offErrorMsg" style="color:red"></p>
                            </div>
                            <div class="form-group col-md-10 col-lg-12">
                                <label for="staff_no">Staff Number</label>
                                <input type="text" class="form-control" name="staff_no" id="staff_no" value="{{$member->staff_no}}">
                            ...
                            <div class="form-group col-md-10 col-lg-10">
                                ...
                                <select class="form-control col-md-10 col-lg-10" id="department" name="department">
                                    ...
                                    <option selected ="{{$member->department}}">{{$member->department}}</option>
                        ...
                        <div style="display: inline-flex;" class="col-md-10 col-lg-12">
                            ...
                            <div class="form-group col-md-10 col-lg-12">
                                ...
                                <input type="text" class="form-control" id="residential_address" name="residential_address" value="{{$member->residential_address}}">
                        ...
                        <div style="display: inline-flex;" class="col-md-10 col-lg-12">
                            <div class="form-group col-md-10 col-lg-10">
                                ...
                                <select class="form-control col-md-10 col-lg-10" id="state_of_origin" name="state_of_origin">
                                    <option selected value="{{$member->state_of_origin}}">{{$member->state_of_origin}}</option>
                        ...
                        <div style="display: inline-flex;" class="col-md-10 col-lg-12">
                            <div class="form-group col-md-10 col-lg-10">
                                <label for="first_name">First Name</label>
                                <input type="text" class="form-control" name="nok_fname" id="nok_fname" value="{{$member->nok_fname}}">
                                <p id="nkfnErrorMsg" style="color:red"></p>
                            </div>
                            <div class="form-group col-md-10 col-lg-10">
                                <label for="middle_name">Middle Name</label>
                                <input type="text" class="form-control" name="nok_mname" id="nok_mname" value="{{$member->nok_mname}}">
                                <p id="nkmnErrorMsg" style="color:red"></p>
                            </div>
                            <div class="form-group col-md-10 col-lg-10">
                                <label for="last_name">Last Name</label>
                                <input type="text" class="form-control" name="nok_lname" id="nok_lname" value="{{$member->nok_lname}}">
                        ...
                        <div style="display: inline-flex;" class="col-md-10 col-lg-12">
                            <div class="form-group col-md-10 col-lg-10">
                                ...
                                <input type="text" class="form-control" min="11" maxlength="11" name="nok_tel" id="nok_tel" value="{{$member->nok_phone_number}}">
                                <p id="nkfnErrorMsg" style="color:red"></p>
                            </div>
                            <div class="form-group col-md-10 col-lg-10">
                                <label for="middle_name">Residential Address</label>
                                <input type="text" class="form-control" name="nok_address" id="nok_address" value="{{$member->nok_address}}">
                                <p id="nkrdErrorMsg" style="color:red"></p>
                            </div>
                            <div class="form-group col-md-10 col-lg-10">
                                <label for="last_name">Relationship</label>
                                <input type="text" class="form-control" name="nok_relationship" id="nok_relationship" value="{{$member->nok_relationship}}">
                        ...
                        <div style="display: inline-flex;" class="col-md-10 col-lg-12">
                            <div class="form-group col-md-10 col-lg-10">
                                ...
                                <select class="form-control col-md-10 col-lg-10" id="referee_one" name="referee_one">
                                    ...
                                    <option selected value="{{$member->referee_one}}">{{$member->referee_one}}</option>
                            ...
                            <div class="form-group col-md-10 col-lg-10">
                                ...
                                <select class="form-control col-md-10 col-lg-10" id="referee_two" name="referee_two">
                                    <option selected>select referee</option>
                                    <option selected value="{{$member->referee_two}}">{{$member->referee_two}}</option>
                                    @foreach($users as $user)
                                        <option value="{{$user}}">{{$user}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div style="display: inline-flex;" class="col-md-10 col-lg-12">
                            <div class="form-group col-md-10 col-lg-10">
                              ...
                              {{-- <option value="{{$banks->users->user_id->bank_name}}">{{$banks->users->user_id->bank_name}}</option>--}}
