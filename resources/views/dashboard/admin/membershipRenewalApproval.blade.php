                    ...
                    <div class="col-xs-12">
                        <div class="box box-danger">
                            <div class="box-header">
                                @if($application->membership_renewal_status == 'Request Submitted')
                                ...
                                <script>
                                    ...
                                    $( "#reject_loan" ).on( "click", function(e) {
                                        ...
                                        $.ajax({
                                            url: '{{URL::to('/handleAdminMembershipRenewal')}}',
                                            type: 'POST',
                                            dataType: 'json',
                                            data: data,
                                                        ...
                                                        <table class="table table-bordered table-striped"  style="border: 2px;font-size: medium">
                                                            ...
                                                            <tr>
                                                                <td style="border: 1px solid black; width: 150px">
                                                                    <img src="{{asset('/storage/'. $application->passport_url)}}" class="user-image" height="100" width="150">
                                                                </td>
                                                                <td>
                                                                    <strong>First Name:</strong>&#160;&#160;&#160;{{$application->members->first_name}}<br/>
                                                                    @if($application->members->middle_name != '')<strong>Middle Name:</strong>&#160;&#160;&#160;{{$application->members->middle_name}}<br/>@endif
                                                                    <strong>Last Name:</strong>&#160;&#160;&#160;{{$application->members->last_name}}<br/>
                                                                    <strong>Gender:</strong>&#160;&#160;&#160;{{$application->members->gender}}<br/>
                                                                    <strong>Email:</strong>&#160;&#160;&#160;{{$application->email}}<br/>
                                                                    <strong>Telephone:</strong>&#160;&#160;&#160;{{$application->phone_no}}<br/>
                                                                    <strong>Contact Address:</strong>&#160;&#160;&#160;{{$application->members->residential_address}}<br/>
                                                                </td>
                                                                <td>
                                                                    <strong>Membership No:</strong>&#160;&#160;&#160;{{$application->member_id}}<br/>
                                                                    <strong>Account No:</strong>&#160;&#160;&#160;{{$application->ippis_no}}<br/>
                                                                    <strong>Designation:</strong>&#160;&#160;&#160;{{$application->members->designation}}<br/>
                                                                    <strong>Department:</strong>&#160;&#160;&#160;{{$application->members->department}}<br/>
                                                                    <strong>Office Location:</strong>&#160;&#160;&#160;{{$application->members->office_location}}<br/>
                                                                </td>
                                                                <td>
                                                                    <strong>First Name:</strong>&#160;&#160;&#160;{{$application->members->nok_fname}}<br/>
                                                                    @if($application->members->nok_mname != '')<strong>Middle Name:</strong>&#160;&#160;&#160;{{$application->members->nok_mname}}<br/>@endif
                                                                    <strong>Last Name:</strong>&#160;&#160;&#160;{{$application->members->nok_lname}}<br/>
                                                                    <strong>Relationship:</strong>&#160;&#160;&#160;{{$application->members->nok_relationship}}<br/>
                                                                    <strong>Telephone:</strong>&#160;&#160;&#160;{{$application->members->nok_phone_number}}<br/>
                                                                    @if($application->members->nok_email != '')<strong>Email:</strong>&#160;&#160;&#160;{{$application->members->nok_email}}<br/>@endif
                                                                    <strong>Contact Address:</strong>&#160;&#160;&#160;{{$application->members->nok_address}}<br/>
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
