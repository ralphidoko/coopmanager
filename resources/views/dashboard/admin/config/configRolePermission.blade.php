                                        ...
                                        @foreach($users as $user)
                                            @if($user->user_role)
                                                <tr>
                                                    ...
                                                    <td><i class="fa fa-fw fa-undo" id="{{$user->id}}" style="cursor: pointer;font-size: large;color:red;"></i></td>
                                                </tr>
                                            @endif
                                        @endforeach
                                        </tbody>
                                        ...
                                        $(document).ready(function(){
                                            $("#save").on("click",function(e) {
                                                ...
                                                if(selectedUserID ===''){
                                                    ...
                                                    data={_token:"{{csrf_token()}}",selectedUserID:selectedUserID, selectedUserRole:selectedUserRole};

                                                    $.ajax({url:'{{URL::to('/assignUserRole')}}',
                                                        type:'POST',
                                                        dataType:'json',
                                                        data:data,
                                                        success:function(response){
                                            ...
                                            $(".fa-undo").click(function(){
                                                ...
                                                if(sure===!1){return!1}
                                                    ...
                                                    $.ajax({url:'{{URL::to('/revokeUserRole')}}',
