                                    ...
                                    <table id="example-2" class="table table-bordered table-striped">
                                        ...
                                        @foreach($products as $product)
                                            <tr>
                                                ...
                                                <td><i class="fa fa-fw fa-edit" id="{{$product->id}}" style="cursor: pointer"></i>&#160;<i class="fa fa-fw fa-trash-o" id="{{$product->id}}" style="cursor: pointer"></i></td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
                                    <script>
                                        ...
                                        $(".fa-trash-o").click(function(){
                                            ...
                                            if(sure===!1){return!1}
                                                ...
                                                $.ajax({url:'{{URL::to('/deleteLoanProduct')}}',
                                        ...
                                        $(document).ready(function(){
                                            $("#save").on("click",function(e) {
                                                ...
                                                if(productName ===''){
                                                    ...
                                                    data={_token:"{{csrf_token()}}",productName:productName, productDescription:productDescription,productPrice:productPrice,productID:productID};

                                                    $.ajax({url:'{{URL::to('/createLoanProduct')}}',
                                                        type:'POST',
                                                        dataType:'json',
                                                        data:data,
                                                        success:function(response){
                                        ...
                                        $(document).ready(function(){
                                            $("#updateAccount").on("click",function(e) {
                                                ...
                                                if(productName===''){
                                                    ...
                                                    data={_token:"{{csrf_token()}}",productID:productID,productName:productName, productDescription:productDescription, productPrice:productPrice};
                                                    $.ajax({url:'{{URL::to('/createLoanProduct')}}',
                                                        type:'POST',
                                                        dataType:'json',
                                                        data:data,
