            ...
            <section class="content">
                <div class="row">
                    <div class="col-xs-12">
                                        ...
                                        <div class="form-group payment" >
                                            ...
                                            <div id="pj">
                                                ...
                                                <select class="form-control col-lg-12 col-md-5 col-sm-3" id="payment_journal" style="width: 100%;">
                                                    <option value="">Select</option>
                                                    @foreach($paymentJournals as $paymentJournal)
                                                        <option value="{{$paymentJournal->id}}">{{$paymentJournal->name}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        @php $counter = 1; @endphp
                                          @foreach($expenses as $expense)
                                            <tr>
                                                ...
                                                <td hidden>{{$expense->account_id}}</td>
                                                <td hidden>{{$paymentJournal->id}}</td>
                                                <td><i class="fa fa-fw fa-eye" id="{{$expense->id}}" style="cursor: pointer"></i></td>
                                            </tr>
                                          @endforeach
                                        </tbody>
                                    </table>
                                    ...
                                    <script>
                                        ...
                                        $(document).ready(function(){
                                            ...
                                            $("#save").on("click",function(e) {e.preventDefault();
                                                ...
                                                if(description===''){
                                                    ...
                                                    data={_token:"{{csrf_token()}}",vendor:vendor, description:description, product:product, date:date,quantity:quantity,unit_price:unit_price,coa:coa,payment_journal:payment_journal,sub_total:sub_total};
                                                    $.ajax({url:'{{URL::to('/registerCoopExpense')}}',
                                                        type:'POST',
                                                        dataType:'json',
                                                        data:data,
                                            ...
                                            $(".repostEntry").on("click",function(e) {e.preventDefault();
                                                ...
                                                if(description===''){
                                                    ...
                                                    data={_token:"{{csrf_token()}}",vendor:vendor, description:description, product:product, date:date,quantity:quantity,unit_price:unit_price,coa:coa,payment_journal:payment_journal,sub_total:sub_total,expenseNumber:expenseNumber};
                                                    $.ajax({url:'{{URL::to('/reportExpenses')}}',
                                                        type:'POST',
                                                        dataType:'json',
                                                        data:data,
                                                        success:function(response){
                                        ...
                                        $(".cancel_entry").click(function(){
                                            ...
                                            if(sure===!1){return!1}
                                                ...
                                                data={_token:"{{csrf_token()}}",expenseID:expenseID};
                                                $.ajax({url:'{{URL::to('/cancelExpense')}}',
                        ...
                        <div class="row">
                            <span class="pull-right totalExpense" style="margin-right: 140px;font-size: 40px;font-weight: bolder">Total Expenses:<del style="text-decoration-style: double">N</del>{{number_format($totalExpense,2)}}</span>
                        </div>
                    </div>
                    <!-- /.col -->
                </div>
